...
subject to AlternateCycling {i in PATIENT_DONOR_PAIRS, j in PATIENT_DONOR_PAIRS, k in PATIENT_DONOR_PAIRS, l in PATIENT_DONOR_PAIRS: i <> j and j <> k and i <> k and k<>l and l<>i and l<>j}: x[i,j]+x[j,k] + x[k,l] <= 2;